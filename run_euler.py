...
#Determining the amount of counts to run the simulation.
countmax = tmax / dt
count = 0
#Running iteration for each point
...
axs[0].set_title("Euler Explicit Method")


axs[1].plot(time_list, TE, label="energy")
axs[1].set_xlabel("time [s]")
axs[1].set_ylabel("Total Energy [J]")
plt.savefig(f"graphs_displacement_energy_euler_dt:{dt}.pdf")
plt.close()
